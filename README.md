...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyiron_experimental-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11822&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyiron_experimental-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyiron_experimental` can be installed with:

```
conda install pyiron_experimental
```

It is possible to list all of the versions of `pyiron_experimental` available on your platform with:
